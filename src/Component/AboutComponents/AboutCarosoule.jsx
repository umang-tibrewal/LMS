      ...
      <Carousel>
        <div className="flex h-full relative" style={{ height: '1200px' }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-white text-4xl font-bold mb-72 "  style={{marginRight:"71.5rem"}}>About us</p>
           
          </div>
          <div className="absolute inset-0 flex items-center justify-center p-28 mt-6">
