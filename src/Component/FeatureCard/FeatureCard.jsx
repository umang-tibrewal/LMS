  ...
  return (
    <div className='flex flex-wrap mt-10 ml-8 mr-7 text-center justify-center bg-gray-100 py-10'>
      <Card className="max-w-sm d-flex flex-column align-items-center hover:shadow-2xl bg-white transition duration-300 ease-in-out transform hover:scale-105">
        ...
        <p className="font-normal text-gray-700 dark:text-gray-400 font-serif text-justify">
      ...
      <Card className="max-w-sm d-flex flex-column align-items-center hover:shadow-2xl bg-white transition duration-300 ease-in-out transform hover:scale-105 ml-7">
